...
class LicensePlateUploadScreen extends StatefulWidget {
  const LicensePlateUploadScreen({super.key});

  @override
  State<LicensePlateUploadScreen> createState() => _LicensePlateUploadScreenState();
}

class _LicensePlateUploadScreenState extends State<LicensePlateUploadScreen> {
  ...
  Future<void> _requestPermissions() async {
    if (Platform.isAndroid) {
      ...
      if (statuses[Permission.camera] != PermissionStatus.granted ||
        ...
        Get.snackbar(
          'Permission Error',
          'Camera and storage permissions are required to upload your license plate.',
  ...
  void _navigateToPreview() {
    if (_licensePlateImage != null) {
      Get.toNamed(
        Routes.licensePlatePreviewScreen,
        arguments: {'imageFile': _licensePlateImage},
      );
    } else {
      Get.snackbar(
        'Error',
        'Please upload your license Plate image first',
        snackPosition: SnackPosition.BOTTOM,
        backgroundColor: Colors.red,
        colorText: Colors.white,
        duration: const Duration(seconds: 2),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const SizedBox(height: 20),
              Text(
                'Upload a photo of your vehicle license Plate',
                style: TextStyle(
                  fontFamily: 'Poppins',
                  fontSize: 18,
                  fontWeight: FontWeight.w600,
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                  image: FileImage(_licensePlateImage!),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
