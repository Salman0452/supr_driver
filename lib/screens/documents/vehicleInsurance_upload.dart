...
class VehicleInsuranceUpload extends StatefulWidget {
  const VehicleInsuranceUpload({super.key});

  @override
  State<VehicleInsuranceUpload> createState() => _VehicleInsuranceUploadState();
}
...
class _VehicleInsuranceUploadState extends State<VehicleInsuranceUpload> {
  ...
  Future<void> _requestPermissions() async {
    if (Platform.isAndroid) {
      ...
      if (statuses[Permission.camera] != PermissionStatus.granted ||
        ...
        Get.snackbar(
          'Permission Error',
          'Camera and storage permissions are required to upload your vehicle insurance.',
      ...
      if (statuses[Permission.camera] != PermissionStatus.granted ||
        ...
        Get.snackbar(
          'Permission Error',
          'Camera and photo library permissions are required to upload your vehicle insurance.',
          snackPosition: SnackPosition.BOTTOM,
          backgroundColor: Colors.red,
          colorText: Colors.white,
          duration: const Duration(seconds: 3),
  ...
  void _navigateToPreview() {
    if (_insuranceImage != null) {
      Get.toNamed(
        Routes.vehicleInsurancePreview,
        arguments: {'imageFile': _insuranceImage},
      );
    } else {
      Get.snackbar(
        'Error',
        'Please upload your vehicle insurance first',
        snackPosition: SnackPosition.BOTTOM,
        backgroundColor: Colors.red,
        colorText: Colors.white,
        duration: const Duration(seconds: 2),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const SizedBox(height: 20),
              Text(
                'Upload a photo of your vehicle Insurance',
                style: TextStyle(
                  fontFamily: 'Poppins',
                  fontSize: 18,
                  fontWeight: FontWeight.w600,
