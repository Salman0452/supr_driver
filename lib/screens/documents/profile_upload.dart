...
class _ProfileUploadScreenState extends State<ProfileUploadScreen> {
    ...
    try {
      if (Platform.isAndroid) {
        ...
        if (statuses[Permission.camera] != PermissionStatus.granted ||
          ...
          Get.snackbar(
            'Permission Error',
            'Camera and storage permissions are required to upload your profile picture.',
        ...
        if (statuses[Permission.camera] != PermissionStatus.granted ||
          ...
          Get.snackbar(
            'Permission Error',
            'Camera and photo library permissions are required to upload your profile picture.',
            snackPosition: SnackPosition.BOTTOM,
            backgroundColor: Colors.red,
            colorText: Colors.white,
            duration: const Duration(seconds: 3),
  ...
  void _navigateToPreview() {
    if (_profileImage != null) {
      Get.toNamed(
        Routes.profilePreviewScreen,
        arguments: {'imageFile': _profileImage},
      );
    } else {
      Get.snackbar(
        'Error',
        'Please upload your profile picture first',
        snackPosition: SnackPosition.BOTTOM,
        backgroundColor: Colors.red,
        colorText: Colors.white,
        duration: const Duration(seconds: 2),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Upload Container - Circle for profile picture
              GestureDetector(
