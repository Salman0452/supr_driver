...
class LicensePlatePreviewScreen extends StatelessWidget {
  const LicensePlatePreviewScreen({super.key});
  ...
  void _handleSubmission(BuildContext context) {
    ...
    Get.toNamed(Routes.vehicleInsuranceUpload);
  }
}