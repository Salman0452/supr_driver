...
class _EmailVerificationScreenState extends State<EmailVerificationScreen> {
  ...
  void _completeVerification() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Email verified successfully!',style: TextStyle(color: Colors.black),),
  ...
  void _resendOtp() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('OTP resent successfully',style: TextStyle(color: Colors.black),),
        backgroundColor: AppColors.PrimaryColor,
      ),
    );
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Check your mail, we have sent a 4-digit verification code to\n${widget.email}',
                ...
                TextButton(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      fontFamily: 'Poppins',
                      fontSize: 16,
                      color: isDarkMode ? AppColors.lightSecondaryColor : AppColors.SecondaryColor,                      fontWeight: FontWeight.w500,
